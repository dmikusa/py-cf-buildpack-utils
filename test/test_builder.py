...
class TestFileUtil(object):
    ...
    def test_all_files(self):
        ...
        assert not fu._filters[0]('./test/data/.bp-config')
    ...
    def test_all_folders(self):
        ...
        assert fu._filters[0]('./test/data/.bp-config')
    ...
    def test_done_with_filters(self):
        ...
        try:
            ...
            assert os.path.exists(tmp + '/.bp-config')
            assert os.path.isdir(tmp + '/.bp-config')
            assert os.path.exists(tmp + '/.bp-config/options.json')
            assert os.path.isfile(tmp + '/.bp-config/options.json')
            eq_(1, len(os.listdir(tmp + '/.bp-config')))
    ...
    def test_done_move_with_filters(self):
        ...
        try:
            ...
            assert os.path.exists(tmp2 + '/.bp-config')
            assert os.path.isdir(tmp2 + '/.bp-config')
            assert os.path.exists(tmp2 + '/.bp-config/options.json')
            assert os.path.isfile(tmp2 + '/.bp-config/options.json')
            eq_(1, len(os.listdir(tmp2 + '/.bp-config')))
...
class TestModuleInstaller(object):
    ...
    def test_default_load_modules(self):
        ...
        res = mi._default_load_method('test/data/modules.mods')
        eq_(3, len(res))
        eq_('Module1', res[0])
        eq_('Module2', res[1])
        eq_('Module3', res[2])
        res = mi._load_modules('test/data/modules.mods')
        eq_(3, len(res))
        eq_('Module1', res[0])
        eq_('Module2', res[1])
        eq_('Module3', res[2])
    ...
    def test_regex_load_method(self):
        ...
        res = mi._regex_load_method('test/data/modules.mods')
        eq_(3, len(res))
        eq_('Module1', res[0])
        eq_('Module2', res[1])
        eq_('Module3', res[2])
    ...
    def test_from_application_file(self):
        mi = ModuleInstaller(self.inst, 'LOCAL')
        res = mi.from_application('modules.mods')
        eq_(mi, res)
